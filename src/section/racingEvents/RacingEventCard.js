			...
			<div className="uk-text-center">
				<div className="uk-inline-clip uk-transition-toggle" tabIndex="0">
					...
					<div className="racing-button-panel uk-overlay uk-overlay-default uk-position-bottom uk-text-center uk-padding-remove">
						<button className="racing-button uk-button uk-button-default uk-width-1-3 uk-margin-remove"><span className="racing-button-icon" uk-icon="icon: world; ratio: 2"></span></button>
						<button className="racing-button uk-button uk-button-default uk-width-1-3 uk-margin-remove"><span className="racing-button-icon" uk-icon="icon: info; ratio: 2"></span></button>
						<button className="racing-button uk-button uk-button-default uk-width-1-3 uk-margin-remove"><span className="racing-button-icon" uk-icon="icon: users; ratio: 2"></span></button>
					</div>
				</div>
			</div>
		);
